...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    tier: 'recommended',
    sortOrder: 1,
    shortDescription: 'OpenAI coding agent (Codex Plus minimum)',
    requiresSubscription: true,
    subscriptionNote: 'Codex Plus required (Codex Pro recommended)',
    whyNeeded: 'Secondary AI agent. Different model = different perspectives. Requires Codex Plus or Pro subscription.',
